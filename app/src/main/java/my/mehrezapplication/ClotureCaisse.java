...
public class ClotureCaisse extends AppCompatActivity implements OnItemSelectedListener,ListView.OnItemClickListener, View.OnClickListener {
   ...
   Spinner spinner1,spinner2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(ClotureCaisse.this);
        getJSON();
        ...
        StringRequest stringRequest = new StringRequest(urlm, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ClotureCaisse.this, android.R.layout.simple_spinner_dropdown_item, list1);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ClotureCaisse.this, error.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            public void onResponse(String response) {
              ...
              //  String id = "";
                ...
                try {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(ClotureCaisse.this, android.R.layout.simple_spinner_item, list2);
    ...
    private void showallaffectation(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                ClotureCaisse.this, list, R.layout.row_item,
    ...
    private void getJSON() {
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ClotureCaisse.this, "Récupération des données", "Attendez...", false, false);
            }
    ...
    private void confirmDeleteAff(){
        ...
        alertDialogBuilder.setPositiveButton("Oui",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteaff();
                        Intent i = new Intent(ClotureCaisse.this,Acceuil.class);
                        startActivity(i);
        ...
        private void deleteaff(){
            class DeleteEmployee extends AsyncTask<Void,Void,String> {
                ...
                protected void onPreExecute() {
                    super.onPreExecute();
                    loading = ProgressDialog.show(ClotureCaisse.this, "Suppression En Cours...", "Attendez...", false, false);
                }
                ...
                protected void onPostExecute(String s) {
                    super.onPostExecute(s);
                    loading.dismiss();
                    Toast.makeText(ClotureCaisse.this, s, Toast.LENGTH_LONG).show();
                }
    ...
    private void AffectationCarte(){
        ...
        class AffectationCarte extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ClotureCaisse.this,"Affectation En Cours...","Attendez...",false,false);
            }
