...
public class ListeFactureVente extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemClickListener(ListeFactureVente.this);
    ...
    private void showEmployee(){
        ...
        ListAdapter adapter = new SimpleAdapter(
                ListeFactureVente.this, list, R.layout.row_item,
    ...
    private void getJSON() {
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ListeFactureVente.this, "Fetching Data", "Wait...", false, false);
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(ListeFactureVente.this, ViewEmploye.class);
