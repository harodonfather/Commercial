...
public class Heure extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv= (ListView) findViewById(R.id.lv);
            ...
            lv.setOnItemClickListener(Heure.this);
    ...
    private void showHeure() {
        ...
        ListAdapter adapter = new SimpleAdapter(
                Heure.this, list, R.layout.row_item,
...

    {
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Heure.this, "Fetching Data", "Wait...", false, false);
            }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, ViewHeure.class);
